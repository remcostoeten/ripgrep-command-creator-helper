...
let latestCommitCache: { data: CommitData | null; timestamp: number } = {
  data: null,
  timestamp: 0,
};
...
async function fetchLatestCommit(): Promise<CommitData | null> {
  ...
  try {
    const res = await fetch(
      'https://api.github.com/repos/remcostoeten/ripgrep-command-creator-helper/commits'
    );
  ...
  return (
    <footer class="footer">
      <div class="footer__top">
        <span>
          Press <kbd>/</kbd> to focus search • Press <kbd>Enter</kbd> to generate • Built by{' '}
          <a href="https://github.com/remcostoeten" target="_blank">
            Remco Stoeten
          </a>{' '}
          utilizing <kbd>Solid.JS</kbd>
        </span>
      </div>
